...
export const PANEL_META: Record<PanelId, PanelMeta> = {
  entityInfo: { id: 'entityInfo', title: 'Entitätsinfo', icon: Info, description: 'Maße und Eigenschaften der Auswahl' },
  ...
  styles: { id: 'styles', title: 'Stile', icon: SwatchBook, description: 'Flächen, Kanten, Hintergrund' },
  ...
  softenEdges: { id: 'softenEdges', title: 'Kanten weichzeichnen', icon: Waves, description: 'Glättungswinkel der Auswahl' },
