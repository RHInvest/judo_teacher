 ...
 * und "ss" auf ihre Ersatzschreibweise (AE, OE, UE, SS).
 *
 * Diese Datei ist reine Anzeige-Logik: sie entscheidet nichts ueber die
 * Geometrie, sondern sagt dem Nutzer im Dialog vorher, was aus seiner
 * Eingabe wird. Die Abbildung muss deshalb mit der des Werkzeugs
 * uebereinstimmen - aendert sich dort etwas, aendert es sich hier mit.
 */
